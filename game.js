...
(function () {
  ...
  class Game {
    constructor(canvas) {
      ...
      this._bgmCfg = { vol: 0.8, type: 'sine', step: 0.44, scale: [164.81,196,220,246.94,293.66,329.63,392,440], bass: [164.81,196], bassEvery: 8, btnBg: 'rgba(44,60,28,0.5)', btnFg: '#f4f8e8' }
